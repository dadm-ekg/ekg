...
public:
    ...
    virtual SignalRange GetViewRange() const = 0;
    ...
    virtual std::shared_ptr<std::vector<SignalDatapoint>> GetData() const = 0;
    ...
    virtual std::shared_ptr<std::vector<SignalDatapoint>> GetFilteredData() const = 0;
