...
public:
    ...
    Detect(std::vector<SignalDatapoint> datapoints, int frequency) override {
        // TODO(Wiktor Raczek): trzeba uzupełnić. Ta metoda musi zwrócić wektor RPeaksAnnotatedSignalDatapoint z uzupełnionymi wartościami RPeaksAnnotatedSignalDatapoint.peak = true, jeżeli w danym punkcie występuje górka
    };
};
